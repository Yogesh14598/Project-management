...
import ReportProjectDate from "./components/Reports/ReportProjectDate";
import ReportProjectdeadline from "./components/Reports/ReportProjectdeadline";
import ReportBillingDate from "./components/Reports/ReportBillingDate";
import ReportBillingdeadline from "./components/Reports/ReportBillingdeadline";
import MyAccount from "./components/MyAccount/MyAccount";
import TaskProjDetails from "./components/TaskManagement/TaskProjDetails";
import TaskTeamdetail from "./components/TaskManagement/TaskTeamdetail";
import VeiwTasks from "./components/TaskManagement/VeiwTasks";
import Demomodel from "./components/TaskManagement/Demomodel";
import Tasks from "./components/TaskManagement/Tasks";
import VeiwTaskTeam from "./components/TaskManagement/ViewTaskTeam";
    ...
    <div className="App">
      <Router>
        <Switch>
          ...
          />
          <ProtectedRoute
            path="/admin/master-menu/project-technologies"
          ...
          <Route path="/OptVal" component={OptVal} />
          ...
          <ProtectedRoute
            path="/ReportProjectDate"
            component={ReportProjectDate}
          />
          <ProtectedRoute path="/taskTeamdetail" component={TaskTeamdetail} />
          <ProtectedRoute
            path="/ReportProjectdeadline"
            component={ReportProjectdeadline}
          />
          <ProtectedRoute path="/veiwTask" component={VeiwTasks} />

          <ProtectedRoute
            path="/ReportBillingdeadline"
            component={ReportBillingdeadline}
          />

          <ProtectedRoute
            path="/ReportBillingDate"
            component={ReportBillingDate}
          />
          <ProtectedRoute
          ...
          <ProtectedRoute path="/taskProjDetails" component={TaskProjDetails} />
          <ProtectedRoute path="/admin/reports" component={Reports} /> 
          <ProtectedRoute path="/demomodel" component={Demomodel} />
