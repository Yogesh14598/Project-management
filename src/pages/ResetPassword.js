...
const ResetPassword = () => {
  ...
  const onReset = (e) => {
    ...
    axios
      .post(url, qs.stringify(resetdetails), {
        headers: {
      ...
      .then((response) => {
        ...
        if (response.status == 201) {
          ...
          toast("password must be match and min 8 characters should be there", {
            type: "error",
          });
        }
      })
  ...
  return (
    <div className="login_manage">
      ...
      <div className="login_manage_block">
        ...
        <div className="login_manage_block_r">
          <div className="forgotpassword_info login_manage_block_r_sec">
            ...
            <span>
              Your Email is verified : example@gamil.com <br />
            ...
            <form className="my-4">
              ...
              <div className="text-center">
                <button type="submit" className="btn_val" onClick={onReset}>
                  Submit
                </button>
      ...
      <div style={{ color: "#fff" }}>{JSON.stringify(resetdetails)}</div>
    </div>
  );
};
