...
const UserLogBasedondate = () => {
  ...
  const datewiseurl = `${BASE_URL}/admin/user-log-activity?dateFrom=${logstartdate}&dateTo=${logenddate}`;
  let token = localStorage.getItem("auth_token");
  const datepagewiseurl = `${BASE_URL}/admin/user-log-activity?page=${selectvalactivities}&dateFrom=${startdate}&dateTo=${enddate}`;
