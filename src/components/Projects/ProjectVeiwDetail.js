...
import Spleit from "../../components/Spliet/Spleit";
...
function ProjectDetail({ history }) {
  ...
  console.log(status);
  localStorage.setItem("projclientName", projectDetails.clientName);
  useEffect(() => {
    axios
      .get(`${BASE_URL}/admin/project-management/projects/${projectId}`, {
        headers: {
      ...
      .then((response) => {
        ...
        localStorage.setItem("referral", response.data.project.referral);

        localStorage.setItem("projectstatuss", response.data.project.status);
        localStorage.setItem(
          "potentialProject",
          response.data.project.potentialProject
        );
        localStorage.setItem(
          "Projectclient_id",
          response.data.project.client_id
        );
        localStorage.setItem(
          "lastDate",
  ...
  const handleUpload = (e) => {
    ...
    axios
      .post(`${BASE_URL}/admin/project-management/documents`, formData, {
        headers: {
          Authorization: `Bearer ${token}`,
          "Access-Control-Allow-Origin": "*",
          "Access-Control-Allow-Methods": "GET,PUT,POST,DELETE,PATCH,OPTIONS",
  ...
  useEffect(() => {
    axios
      .get(`${BASE_URL}/admin/project-management/projects/${projectId}/urls`, {
        headers: {
          Authorization: `Bearer ${token}`,
          "Access-Control-Allow-Origin": "*",
          "Access-Control-Allow-Methods": "GET,PUT,POST,DELETE,PATCH,OPTIONS",
  ...
  useEffect(() => {
    axios
      .get(`${BASE_URL}/admin/masterMenu/projectStatusList`, {
        headers: {
          Authorization: `Bearer ${token}`,
          "Access-Control-Allow-Origin": "*",
          "Access-Control-Allow-Methods": "GET,PUT,POST,DELETE,PATCH,OPTIONS",
  ...
  useEffect(() => {
    axios
      .get(
        `${BASE_URL}/admin/project-management/projects/${projectId}/documents`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
            "Access-Control-Allow-Origin": "*",
  ...
  useEffect(() => {
    axios
      .get(
        `${BASE_URL}/admin/project-management/projects/${projectId}/documents?documentType=other`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
            "Access-Control-Allow-Origin": "*",
  ...
  //display documentents by document type invoice

  const [documentByTypeInvoice, setDocumentByTypeInvoice] = useState([]);

  useEffect(() => {
    axios
      .get(
        `${BASE_URL}/admin/project-management/projects/${projectId}/documents?documentType=invoice`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
            "Access-Control-Allow-Origin": "*",
      ...
      .then((response) => {
        ...
        console.log("Document By Type Fetched Succesfully");
        console.log(response.data.documents);
        setDocumentByTypeInvoice(response.data.documents);
      })
      .catch((error) => {
        console.log(error);
      });
  ...
  //display documentents by document type quotation

  const [documentByTypeQuotation, setDocumentByTypeQuotation] = useState([]);

  useEffect(() => {
    axios
      .get(
        `${BASE_URL}/admin/project-management/projects/${projectId}/documents?documentType=quotation`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
            "Access-Control-Allow-Origin": "*",
      ...
      .then((response) => {
        ...
        console.log("Document By Type Fetched Succesfully");
        console.log(response.data.documents);
        setDocumentByTypeQuotation(response.data.documents);
      })
      .catch((error) => {
        console.log(error);
      });
  ...
  useEffect(() => {
    axios
      .get(
        `${BASE_URL}/admin/project-management/projects/${projectId}/documents?documentType=agreement`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
            "Access-Control-Allow-Origin": "*",
  ...
  useEffect(() => {
    axios
      .get(
        `${BASE_URL}/admin/project-management/projects/${projectId}/documents?documentType=proposal`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
            "Access-Control-Allow-Origin": "*",
  ...
  useEffect(() => {
    axios
      .get(
        `${BASE_URL}/admin/project-management/projects/${projectId}/documents?documentType=requirement`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
            "Access-Control-Allow-Origin": "*",
  ...
  const showDoc = (id) => {
    if (doc) {
      axios
        .get(`${BASE_URL}/admin/project-management/documents/${id}`, {
          headers: {
            Authorization: `Bearer ${token}`,
            "Access-Control-Allow-Origin": "*",
            "Access-Control-Allow-Methods": "GET,PUT,POST,DELETE,PATCH,OPTIONS",
  ...
  // var up = document.getElementsByClassName('checkbox2');
  // var down = document.getElementsByClassName('checkbox3');

  // const GFG_Fun = () => {
  //   parent = document.getElementById('10');
  // children = parent.querySelectorAll('.checkbox3');
  ...
  const deleteHandler = (id) => {
    ...
    if (todelete) {
      axios
        .delete(`${BASE_URL}/admin/project-management/documents/${id}`, {
          headers: {
            Authorization: `Bearer ${token}`,
            "Access-Control-Allow-Origin": "*",
            "Access-Control-Allow-Methods": "GET,PUT,POST,DELETE,PATCH,OPTIONS",
  ...
  useEffect(() => {
    axios
      .get(`${BASE_URL}/admin/project-management/clients/${clientId}`, {
        headers: {
          Authorization: `Bearer ${token}`,
          "Access-Control-Allow-Origin": "*",
          "Access-Control-Allow-Methods": "GET,PUT,POST,DELETE,PATCH,OPTIONS",
  ...
  useEffect(() => {
    axios
      .get(`${BASE_URL}/admin/project-management/projects/${projectId}/teams`, {
        headers: {
          Authorization: `Bearer ${token}`,
          "Access-Control-Allow-Origin": "*",
          "Access-Control-Allow-Methods": "GET,PUT,POST,DELETE,PATCH,OPTIONS",
  ...
  const deleteTeamsHandler = (id) => {
    ...
    if (todelete) {
      axios
        .delete(`${BASE_URL}/admin/project-management/teams/${id}`, {
          headers: {
            Authorization: `Bearer ${token}`,
            "Access-Control-Allow-Origin": "*",
            "Access-Control-Allow-Methods": "GET,PUT,POST,DELETE,PATCH,OPTIONS",
  ...
  const editTeamsHandler = (id) => {
    axios
      .get(`${BASE_URL}/admin/project-management/teams/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`,
          "Access-Control-Allow-Origin": "*",
          "Access-Control-Allow-Methods": "GET,PUT,POST,DELETE,PATCH,OPTIONS",
  ...
  const handleUrl = (e) => {
    ...
    axios
      .post(
        `${BASE_URL}/admin/project-management/urls`,
  ...
  const deleteUrlHandler = (id) => {
    ...
    if (todelete) {
      axios
        .delete(`${BASE_URL}/admin/project-management/urls/${id}`, {
          headers: {
            Authorization: `Bearer ${token}`,
            "Access-Control-Allow-Origin": "*",
            "Access-Control-Allow-Methods": "GET,PUT,POST,DELETE,PATCH,OPTIONS",
  ...
  const editUrlHandler = (id) => {
    axios
      .get(`${BASE_URL}/admin/project-management/urls/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`,
          "Access-Control-Allow-Origin": "*",
          "Access-Control-Allow-Methods": "GET,PUT,POST,DELETE,PATCH,OPTIONS",
  ...
  const handleUrlUpdate = (e) => {
    ...
    axios
      .put(
        `${BASE_URL}/admin/project-management/urls/${urlId}`,
  ...
  const handleStatus = (e) => {
    ...
    axios
      .post(
        `${BASE_URL}/admin/masterMenu/projectStatusList`,
  ...
  const editStatusHandler = (id) => {
    axios
      .get(`${BASE_URL}/admin/masterMenu/projectStatusList/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`,
          "Access-Control-Allow-Origin": "*",
          "Access-Control-Allow-Methods": "GET,PUT,POST,DELETE,PATCH,OPTIONS",
  ...
  const deleteStatusHandler = (id) => {
    ...
    if (todelete) {
      axios
        .delete(`${BASE_URL}/admin/masterMenu/projectStatusList/${id}`, {
          headers: {
            Authorization: `Bearer ${token}`,
            "Access-Control-Allow-Origin": "*",
            "Access-Control-Allow-Methods": "GET,PUT,POST,DELETE,PATCH,OPTIONS",
  ...
  const handleStatusUpdate = (e) => {
    ...
    axios
      .put(
        `${BASE_URL}/admin/masterMenu/projectStatusLists/${statusId}`,
  ...
  const updateStatus = (e) => {
    ...
    axios
      .put(
        `${BASE_URL}/admin/project-management/projects/${projectId}`,
      ...
      <div className="Proj_main">
        ...
        <div className="Proj_main_r">
          ...
          >
                ...
                <div className="row my-3">
                  ...
                  <div className="col-md-4">
                    <p>
                      ₹
                      {(
                        projectDetails.cost - installmentDetails.totalPaidAmount
                      ).toFixed(2) < 1
                        ? 0
                        : (
                            projectDetails.cost -
                            installmentDetails.totalPaidAmount
                          ).toFixed(2)}
                    </p>
                  </div>
                </div>
                ...
                <Row>
                      ...
                      >
                        ...
                        <div className="doc-upload-type">
                          ...
                          >
                            ...
                            <option id="agreeement">agreement</option>
                            <option id="requirement">requirement</option>
                            <option id="proposal">proposal</option>
                            <option id="invoice">invoice</option>
                            <option id="quotation">quotation</option>
                  ...
                  <Col md={6}>
                    ...
                    >
                          ...
                          {loading ? (
                            ...
                            documentByTypeProposal.map((item) => (
                              ...
                              >
                                ...
                                ) : item.document.split(".").pop() == "xlsx" ? (
                                  <p className="doc-name">
                                    <a href={item.document}>
                                      {item.name.toUpperCase()}
                                    </a>
                                  </p>
                                ) : item.document.split(".").pop() == "docx" ? (
                                  <p className="doc-name">
                                    <a href={item.document}>
                                      {item.name.toUpperCase()}
                                    </a>
                      ...
                      <Tab eventKey={4} title={<span>Invoice</span>}>
                        <div className="document-show">
                          {loading ? (
                            <Loader />
                          ) : documentByTypeInvoice == "" ? (
                            <Message
                              variant="danger"
                              style={{ margin: "auto" }}
                            >
                            ...
                            documentByTypeInvoice.map((item) => (
                              <div
                                className="doc-cont"
                                onClick={() => showDoc(item.id)}
                              >
                      ...
                      <Tab eventKey={5} title={<span>Quotation</span>}>
                        <div className="document-show">
                          {loading ? (
                            <Loader />
                          ) : documentByTypeQuotation == "" ? (
                            <Message
                              variant="danger"
                              style={{ margin: "auto" }}
                            >
                            ...
                            documentByTypeQuotation.map((item) => (
                              <div
                                className="doc-cont"
                                onClick={() => showDoc(item.id)}
                              >
                      ...
                      <Tab eventKey={6} title={<span>Others</span>}>
                        <div className="document-show">
                          {loading ? (
                            <Loader />
                          ) : documentByTypeOther == "" ? (
            ...
            <Tab eventKey="spliet" title={<span> Spliet </span>}>
              <Spleit />
            </Tab>
          </Tabs>
        </div>
